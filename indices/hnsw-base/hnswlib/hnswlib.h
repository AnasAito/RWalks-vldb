...
namespace hnswlib
{
    ...
    public:
        ...
        virtual size_t get_data_attr_size() = 0;
        virtual size_t get_data_attr_agg_size() = 0;
        virtual DISTFUNC<MTYPE> get_dist_func() = 0;
        virtual DISTFUNC<int> get_dist_func_attr() = 0;
        virtual DISTFUNC<float> get_dist_func_attr_agg() = 0;
        virtual void *get_dist_func_param() = 0;
        virtual void *get_dist_attr_func_param() = 0;
